...
--
-- Host: db:3306
-- Generation Time: Dec 10, 2024 at 09:37 PM
...
(9, '1984', 328, 'Big Brother vous surveille...', 'George Orwell imagine un monde dystopique où Big Brother contrôle tout. Dans cette société totalitaire, la pensée est surveillée et manipulée. Winston Smith, le protagoniste, tente de résister à ce régime oppressif, mais à quel prix ?', 1949, './imgCoverBook/1984_George_orwell.jpg', 'Secker & Warburg', 9, 2, 1),
(10, 'L\'Étranger', 123, 'Aujourd’hui, maman est morte...', 'Albert Camus raconte l’histoire de Meursault, un homme détaché du monde, qui commet un meurtre absurde. Ce roman explore l’absurdité de la vie et la quête de sens dans une société normative.', 1942, './imgCoverBook/L-Etranger.jpg', 'Gallimard', 10, 14, 7);
