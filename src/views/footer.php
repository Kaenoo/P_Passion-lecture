...
-->
<footer class="grid grid-cols-3 mt-8 py-6 bg-green-700 text-white">
    <div class="pl-4 col-start-1 col-span-3 lg:col-span-1 lg:col-start-2 lg:px-8 text-center text-xs lg:text-sm">
